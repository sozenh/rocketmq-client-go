...
import (
	...
	errors2 "github.com/sozenh/rocketmq-client-go/v2/errors"
...
//go:generate mockgen -source client.go -destination mock_client.go -self_package github.com/sozenh/rocketmq-client-go/v2/internal  --package internal RMQClient
